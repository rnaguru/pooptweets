An application to gather Ottawa wastewater data from PHESD github repo, assemble plots, and post the plots @rnaguru ob bluesky whenever there is a new commit.
